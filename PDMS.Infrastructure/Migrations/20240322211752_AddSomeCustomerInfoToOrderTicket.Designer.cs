...
namespace PDMS.Infrastructure.Migrations
{
    ...
    [Migration("20240322211752_AddSomeCustomerInfoToOrderTicket")]
    partial class AddSomeCustomerInfoToOrderTicket
    {
            ...
            modelBuilder.Entity("PDMS.Domain.Entities.OrderTicket", b =>
                {
                    ...
                    b.Property<DateTime?>("ExpectedOrderDate")
                        .HasColumnType("datetime");
            ...
            modelBuilder.Entity("PDMS.Domain.Entities.Customer", b =>
                {
                    ...
                    b.HasOne("PDMS.Domain.Entities.User", "User")
                        .WithOne("Customer")
                        .HasForeignKey("PDMS.Domain.Entities.Customer", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PDMS.Domain.Entities.Employee", b =>
                {
                    ...
                    b.HasOne("PDMS.Domain.Entities.User", "User")
                        .WithOne("Employee")
                        .HasForeignKey("PDMS.Domain.Entities.Employee", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
